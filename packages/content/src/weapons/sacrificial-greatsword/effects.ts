...
export const sacrificialGreatswordCombatCapabilities: readonly CombatEquipmentCapability[] = [{
  weaponId: "SacrificialGreatsword", capability: { id: "weapon.sacrificial-greatsword.skill-reset", label: "祭礼：前台战技伤害触发一次冷却重置",
...
export const sacrificialGreatswordCombatActionEffects: readonly CombatActionEffect[] = []
