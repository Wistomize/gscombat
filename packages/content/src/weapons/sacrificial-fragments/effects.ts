...
export const sacrificialFragmentsCombatCapabilities: readonly CombatEquipmentCapability[] = [{
  weaponId: "SacrificialFragments", capability: { id: "weapon.sacrificial-fragments.skill-reset", label: "祭礼：前台战技伤害触发一次冷却重置",
...
export const sacrificialFragmentsCombatActionEffects: readonly CombatActionEffect[] = []
