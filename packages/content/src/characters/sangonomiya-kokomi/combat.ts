...
export const sangonomiyaKokomiCombatCoverage: CharacterCombatCoverage = {
  capabilities: [
    ...
    { ...declareHitCapability("sangonomiya-kokomi.kit.sustained_skill_hits", "可持续造成战技命中", ["skill"], ["hydro"], true), skillHitOpportunities: { withinSeconds: 7, count: 2, minimumSeparationSeconds: 0.3 } },
  ],
  actions: [
    {
