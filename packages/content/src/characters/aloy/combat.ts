...
export const aloyCombatCoverage: CharacterCombatCoverage = {
  capabilities: [
    declareSkillCastCapability("aloy", 9),
    ...declareWeaponHitCapabilities(aloyDefinition),
    declareHitCapability("aloy.kit.skill_burst_hits", "战技/爆发直接命中准备", ["skill","burst"], ["cryo"]),
  ],
  actions: [
    {
      characterId: "Aloy",
