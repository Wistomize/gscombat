...
export const mualaniCombatCoverage: CharacterCombatCoverage = {
  capabilities: [
    declareSkillCastCapability("mualani", 5),
    ...declareWeaponHitCapabilities(mualaniDefinition),
    declareHitCapability("mualani.kit.skill_burst_hits", "战技/爆发直接命中准备", ["burst"], ["hydro"]),
  ],
  actions: [
    {
      characterId: "Mualani",
