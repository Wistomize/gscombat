...
export const emilieCombatCoverage: CharacterCombatCoverage = {
  capabilities: [
    declareSkillCastCapability("emilie", 6),
    ...declareWeaponHitCapabilities(emilieDefinition),
    declareHitCapability("emilie.kit.skill_burst_hits", "战技/爆发直接命中准备", ["skill","burst"], ["dendro"]),
    { ...declareHitCapability("emilie.kit.sustained_skill_hits", "可持续造成战技命中", ["skill"], ["dendro"], true, "any"), skillHitOpportunities: { withinSeconds: 7, count: 2, minimumSeparationSeconds: 0.3 } },
  ],
  actions: [
    {
      characterId: "Emilie",
