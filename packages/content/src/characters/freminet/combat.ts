...
export const freminetCombatCoverage: CharacterCombatCoverage = {
  capabilities: [
    declareSkillCastCapability("freminet", 11),
    ...declareWeaponHitCapabilities(freminetDefinition),
    declareHitCapability("freminet.kit.skill_burst_hits", "战技/爆发直接命中准备", ["skill","burst"], ["cryo"]),
  ],
  actions: [
    {
