...
export const chioriCombatCoverage: CharacterCombatCoverage = {
  capabilities: [
    ...
    { ...declareHitCapability("chiori.kit.sustained_skill_hits", "可持续造成战技命中", ["skill"], ["geo"], true), skillHitOpportunities: { withinSeconds: 7, count: 2, minimumSeparationSeconds: 0.3 } },
  ],
  actions: [
    {
      characterId: "Chiori",
