...
import { BENNETT_BURST_FIELD_EFFECT_ID } from "@gscombat/content"
...
describe("team scenario", () => {
  ...
  it("derives a C6 teammate Bennett's Pyro damage bonus from Fantastic Voyage for Pyronado", () => {
    ...
    const c5Field = evaluateScenario(createScenario(bennettC5, [BENNETT_BURST_FIELD_EFFECT_ID]), gameData)
    const c6Field = evaluateScenario(createScenario(bennettC6, [BENNETT_BURST_FIELD_EFFECT_ID]), gameData)
