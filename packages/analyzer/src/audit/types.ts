...
export type CombatRegistryIntegrityIssueCode =
  ...
  | "conflicting-damage-formula-routing"
  | "duplicate-action-id"
  | "duplicate-action-effect-id"
  ...
  | "invalid-damage-event-source-constellation"
  ...
  | "invalid-transformative-reaction-crit-effect"
  | "invalid-stellar-swirl-reaction-event"
  | "invalid-action-effect-event-filter"
  | "invalid-additional-damage-event-identity"
  | "invalid-matched-action-scenario-parameter"
  ...
  | "invalid-metric-source-constellation"
  ...
  | "invalid-damage-event-probability"
